                                    ...
                                    @if(count($users)>0)
                                        @foreach($users as $user)
                                            <tr class="remove-{{ $user->id }}">
                                                ...
                                                <td>
                                                    <div data-table="memberships" data-id="{{ $user->id }}"
                                                         data-col="is_active"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.btnDeleteAll').on('click', function () {
                ...
                if ($delete != "") {
                    $.ajax({
                        url: "{{ route('admin.memberships.deleteAll') }}",
                        type: "post",
                        dataType: "text",

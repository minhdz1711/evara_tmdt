                ...
                <div class="col-12 col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Thêm danh Thương hiệu mới</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    @if(count($categories)>0)
                                        @foreach($categories as $category)
                                            <tr class="remove-{{ $category->id }}">
                                                ...
                                                <td>
                                                    {!! \App\Models\Config::showCategoryParent($category->parent_id,'product_brands') !!}
                                                </td>
                                                <td>

                                                    <div data-table="product_brands" data-id="{{ $category->id }}"
                                                         data-col="is_active"
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.brands.edit',$category->id) }}"
                                                       class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
                                                    <a href="#" name="{{ $category->title }}"
                                                       link="{{ route('admin.brands.destroy',$category->id) }}"

                        ...
                        <div class="card-body">
                                            ...
                                            <tr class="remove-{{ $category->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" name="{{ $category->title }}"
                                                       link="{{ route('admin.product-categories.destroy',$category->id) }}"
                            ...
                            <div class="card-bottom">
                                <div class="row">
                                    ...
                                    @if($product_categories->links())
                                        <div class="col-12 col-md-6 col-lg-7">
                                            <div class="float-right">
                                                <div
                                                    class="pagination">{!! $product_categories->links('pagination::bootstrap-4') !!}</div>
                                            </div>
                                        </div>
                                    @endif
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.btnDeleteAll').on('click', function () {
                ...
                if ($delete != "") {
                    $.ajax({
                        url: "{{ route('admin.product-categories.deleteAll') }}",
                        type: "post",
                        dataType: "text",

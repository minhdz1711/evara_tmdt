                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.post-categories.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    @include('admins.layouts.button-add',['url'=>route('admin.post-categories.index'),'display'=>'d-none'])
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                                    ...
                                    @if(count($post_categories)>0)
                                        @foreach($post_categories as $category)
                                            <tr class="remove-{{ $category->id }}">
                                                ...
                                                <td>
                                                    {!! \App\Models\Config::showCategoryParent($category->parent_id,'categories') !!}
                                                </td>
                                                <td>
                                                    <div data-table="categories" data-id="{{ $category->id }}"
                                                         data-col="is_hot"
                                                         class="Switch Round  @if($category->is_hot == 1) On @else Off @endif"
                                                ...
                                                <td>
                                                    <div data-table="categories" data-id="{{ $category->id }}"
                                                         data-col="is_home"
                                                         class="Switch Round  @if($category->is_home == 1) On @else Off @endif"
                                                         style="vertical-align:top;margin-left:10px;">
                                                        <div class="Toggle"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#" name="{{ $category->title }}"
                                                       link="{{ route('admin.post-categories.destroy',$category->id) }}"
                            ...
                            <div class="card-bottom">
                                <div class="row">
                                    ...
                                    @if($post_categories->links())
                                        <div class="col-12 col-md-6 col-lg-7">
                                            <div class="float-right">
                                                <div class="pagination">{!! $post_categories->links('pagination::bootstrap-4') !!}</div>
                                            </div>
                                        </div>
                                    @endif
                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.btnDeleteAll').on('click', function () {
                ...
                if ($delete != "") {
                    $.ajax({
                        url: "{{ route('admin.post-category.deleteAll') }}",
                        type: "post",
                        dataType: "text",

                                            ...
                                            <tr class="remove-{{ $post->id }}">
                                                <td class="center">
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label for="checkall-{{ $post->id }}"
                                                               class="custom-control-label"></label>
                                                    </div>
                                                </td>
                                                <td style="width: 120px">
                                                    <div class="box-image-table">
                                                        <img src="{!! ($post->images!="")?url($post->images):URL::asset('images/no_picture.gif') !!}"
                                                             alt="{{ $post->title }}"
                                                             class="img-table">
                                                    </div>
                                                </td>
                                                <td>@if(strlen(strip_tags($post->title))<100)
                                                        {{$post->title}}
                                                    @else
                                                ...
                                                <td>{!! \App\Models\Config::showCategoryPost($post->id) !!}</td>
                                                <td>{{ $post->view }} (lượt xem)</td>
                                                <td>
                                                    <div data-table="posts" data-id="{{ $post->id }}"
                                                         data-col="is_hot"
                                                         class="Switch Round  @if($post->is_hot == 1) On @else Off @endif"
                                                ...
                                                <td>
                                                    <div data-table="posts" data-id="{{ $post->id }}"
                                                         data-col="is_index"
                                                         class="Switch Round  @if($post->is_index == 1) On @else Off @endif"
                                                         style="vertical-align:top;margin-left:10px;">
                                                        <div class="Toggle"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div data-table="posts" data-id="{{ $post->id }}"
                                                         data-col="is_active"
                                                         class="Switch Round  @if($post->is_active == 1) On @else Off @endif"
                                                         style="vertical-align:top;margin-left:10px;">
                                                        <div class="Toggle"></div>
                                                    </div>
                                                </td>
                                                <td>{!! \App\Models\Config::showAuthor($post->id_user) !!}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" name="{{ $post->title }}"
                                                       link="{{ route('admin.posts.destroy',$post->id) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(".deleteClick").click(function () {
                ...
                $("#deleteMes").html("Bạn muốn xoá bài viết <b>" + name + "</b> ?");
            });

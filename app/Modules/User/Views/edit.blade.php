            ...
            <div class="row">
                <div class="col-12 col-md-6 offset-md-3">
                    <form action="{{ route('admin.users.update',$user->id) }}" method="POST">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control @if($errors->has('phone')) is-invalid @endif" value="{{ $user->phone }}">
                                    @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-md-2">
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" id="customRadio1" name="gender" @if($user->gender==0) checked @endif value="0">
                                                <label for="customRadio1" class="custom-control-label">Nam</label>
                                            </div>
                                        </div>
                                        <div class="col-6 col-md-2">
                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" id="customRadio2" name="gender" value="1" @if($user->gender==1) checked @endif>
                                    ...
                                    <select name="position" class="form-control">
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{ $role->id }}"
                                                    @if($user->position==$role->id) selected @endif>{{ $role->display_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="previewThumbnail" style="width: 200px">
                                        ...
                                        <input type="hidden" name="images" id="image" class="inputImg" value="{{ $user->images }}"/>
                        ...
                        <div class="form-group">
                            @include('admins.layouts.button-edit',['url'=>route('admin.users.index'),'display'=>''])
                        </div>
                    </form>
                </div>
            </div>

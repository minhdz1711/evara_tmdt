                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.categories.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    @include('admins.layouts.button-add',['url'=>route('admin.categories.index'),'display'=>'d-none'])
                                </div>
                            </form>
                        </div>
                    </div>
                                            ...
                                            <tr class="remove-{{ $category->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" name="{{ $category->title }}"
                                                       link="{{ route('admin.categories.destroy',$category->id) }}"
                                    ...
                                    @if($categories->links())
                                        <div class="col-12 col-md-6 col-lg-7">
                                            <div class="float-right">
                                                <div
                                                    class="pagination">{!! $categories->links('pagination::bootstrap-4') !!}</div>
                                            </div>
                                        </div>
                                    @endif
                                </div>

...
<head>
    ...
    <title>Đăng nhập hệ thống website | {{ $settings['website_name'] }}</title>
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="" class="h1"><b>{{ @$settings['title_admin'] }}</b></a>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="icheck-primary">
                            ...
                            <label for="remember" style="font-weight: normal !important;font-size: 15px">
                                Nhớ mật khẩu
                            </label>
                        </div>
                    </div>
